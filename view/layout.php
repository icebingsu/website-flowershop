...
<head>
   ...
   <link rel='stylesheet' id='woof-css' href='wp-content/plugins/woocommerce-products-filter/css/front.css'
      type='text/css' media='all' />
   ...
   <link rel='stylesheet' id='chosen-drop-down-css'
      href='wp-content/plugins/woocommerce-products-filter/js/chosen/chosen.min.css' type='text/css' media='all' />
   <style id='woocommerce-inline-inline-css' type='text/css'>
   .woocommerce form .form-row .required {
      visibility: visible;
   }
   </style>
   <link rel='stylesheet' id='flatsome-main-css' href='wp-content/themes/flatsome/assets/css/flatsome.css'
      type='text/css' media='all' />
   ...
   <link rel='stylesheet' id='flatsome-shop-css' href='wp-content/themes/flatsome/assets/css/flatsome-shop.css'
      type='text/css' media='all' />
   <link rel='stylesheet' id='flatsome-style-css' href='wp-content/themes/flatsome-child/style.css' type='text/css'
      media='all' />
   <link rel='stylesheet' id='all-font-awesome-css'
      href='wp-content/themes/flatsome-child/assets/fontsawesome/css/all.min.css' type='text/css' media='all' />
   ...
   <link rel="alternate" type="application/json+oembed"
      href="wp-json/oembed/1.0/embedd036.json?url=https%3A%2F%2Fshophoa5.muathemewp.com%2F" />
   <link rel="alternate" type="text/xml+oembed"
      href="wp-json/oembed/1.0/embedaa94?url=https%3A%2F%2Fshophoa5.muathemewp.com%2F&amp;format=xml" />
   <style>
...
<body data-rsssl=1
   class="home page-template page-template-page-blank page-template-page-blank-php page page-id-2 theme-flatsome woocommerce-no-js lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border mobile-submenu-slide mobile-submenu-slide-levels-1 mobile-submenu-toggle">
         ...
         <div class="header-wrapper">
               ...
               <div class="flex-row container">
                  ...
                  <div class="flex-col hide-for-medium flex-right">
                     <ul class="nav top-bar-nav nav-right nav-small  nav-divided">
                        <li id="menu-item-294"
                           class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-294 menu-item-design-default">
                           <a href="?mod=blog&act=tintuc" class="nav-top-link">Blog</a>
                        </li>
                        <li id="menu-item-293"
                           class="menu-item menu-item-type-post_type menu-item-object-page menu-item-293 menu-item-design-default">
               ...
               <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                  ...
                  <div id="logo" class="flex-col logo">
                     ...
                     <a href="?mod=page&act=home" title="Mua theme - Theme Wordpress bán hoa tươi mẫu số 5" rel="home">
                        <img width="269" height="58" src="wp-content/uploads/2021/06/logo-shophoa.png"
                           class="header_logo header-logo" alt="Mua theme" /><img width="269" height="58"
                           src="wp-content/uploads/2021/06/logo-shophoa.png" class="header-logo-dark"
                           alt="Mua theme" /></a>
                  </div>
            ...
            flex-grow">
                     <ul class="header-nav header-nav-main nav nav-left  nav-uppercase">
                        <li class="header-send-to"><span class=""><a href="he-thong-cua-hang/index.html"><i
                                    class="fas fa-map-marker-alt"></i>Hệ thống cửa hàng</a></span>
                        </li>
                        <li class="header-search-form search-form html relative has-icon">
                           <div class="header-search-form-wrapper">
                              <div class="searchform-wrapper ux-search-box relative is-normal">
                                 <form role="search" method="post" class="searchform"
                                    action="?mod=page&act=layout_search">
                                    <div class="flex-row relative">
                                       ...
                                       <div class="flex-col flex-grow">
                                          ...
                                          <input type="search" id="woocommerce-product-search-field-0"
                                             class="search-field mb-0" placeholder="Tôi muốn tìm ..." value=""
                                             name="search" />
                                       </div>
                                       <div class="flex-col">
                                          <button type="submit"
                                             class="ux-search-submit secondary button wp-element-button icon mb-0"
                                             aria-label="Submit">
                           ...
                           <a href="gio-hang/index.html"
                              ...
                              <span class="image-icon header-cart-icon" data-icon-label="0">
                                 <img class="cart-img-icon" alt="Giỏ hàng"
                                    src="wp-content/uploads/2021/05/shopping-cart.png" />
                              </span>
                           </a>
                           <!-- Cart Sidebar Popup -->
                              ...
                              <div class="cart-popup-inner inner-padding">
                                 ...
                                 <div class="widget_shopping_cart_content">
                                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                       ...
                                       <li class="woocommerce-mini-cart-item mini_cart_item">
                                          <a href="?mod=cart&act=removecart&id_hoa=<?php echo $showcart['id_hoa'] ?>&id_khachhang=<?php echo $showcart['id_khachhang'] ?>"
                                             ...
                                             data-product_id="368" data-cart_item_key="cf004fdc76fa1a4f25f62e0eb5261ca3"
                                             data-product_sku="">&times;</a> <a href="san-pham/pink-moon/index.html">
                                             <img width="300" height="300"
                                                src="wp-content/uploads/2021/05/<?php echo $showcart['anhhoa'] ?>"
                                                data-src="wp-content/uploads/2021/05/<?php echo $showcart['anhhoa'] ?>"
                                                class="lazy-load attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                alt="" decoding="async" srcset=""
                                                data-srcset="wp-content/uploads/2021/05/<?php echo $showcart['anhhoa'] ?>"
                                                sizes="(max-width: 300px) 100vw, 300px" /><?php echo $showcart['tenhoa'] ?>
                                          </a>
                                          <span class="quantity"><?php echo $showcart['soluong'] ?> &times; <span
                                                class="woocommerce-Price-amount amount"><bdi><?php echo $showcart['tongtien'] ?><span
                                    ...
                                    <p class="woocommerce-mini-cart__buttons buttons"><a
                                          href="?mod=cart&act=cart-details"
                                          class="button wc-forward wp-element-button">Xem giỏ hàng</a><a
                                          href="?mod=cart&act=cart-details"
                                          class="button checkout wc-forward wp-element-button">Thanh toán</a></p>
                                 </div>
                                 <?php endif; ?>
                                 <?php endif; ?>
                                 <!-- hết tại đây-->
                           ...
                           <div class="header-search-form-wrapper">
                              <div class="searchform-wrapper ux-search-box relative is-normal">
                                 <form role="search" method="get" class="searchform"
                                    action="https://shophoa5.muathemewp.com/">
                                    <div class="flex-row relative">
                                       <div class="flex-col search-form-categories">
                                          <select class="search_categories resize-select mb-0" name="product_cat">
                     ...
                     <div class="col-inner">
                        <div class="img has-hover logo x md-x lg-x y md-y lg-y" id="image_924473354">
                           <div class="img-inner image-cover dark" style="padding-top:50px;">
                              <img width="269" height="58" src="wp-content/uploads/2021/06/logo-shophoa-black.png"
                                 class="attachment-original size-original" alt="" decoding="async" loading="lazy" />
                           </div>
                        ...
                        <div class="wpcf7 no-js" id="wpcf7-f141-o1" lang="en-US" dir="ltr">
                           ...
                           <form action="https://shophoa5.muathemewp.com/#wpcf7-f141-o1" method="post"
                              ...
                              <div class="flex-row">
                                 <div class="flex-col flex-grow">
                                    <p><span class="wpcf7-form-control-wrap" data-name="your-email"><input size="40"
                                             ...
                                             aria-required="true" aria-invalid="false" placeholder="Email của tôi"
                                             value="" type="email" name="your-email" /></span>
                                    </p>
                                 </div>
                                 <div class="flex-col">
                                    <p><input class="wpcf7-form-control has-spinner wpcf7-submit button" type="submit"
                                          value="Theo dõi bản tin" />
                                    </p>
                                 </div>
                              </div>
                        ...
                        <div class="ux-menu stack stack-col justify-start">
                           ...
                           <div class="ux-menu-link flex menu-item">
                              <a class="ux-menu-link__link flex"
                                 href="https://giaohangtotnhat.vn/tra-cuu-van-don-best-express/">
                                 <span class="ux-menu-link__text">
                  ...
                  <div id="col-1755648745" class="col mh-footer-bottom medium-12 small-12 large-4">
                     <div class="col-inner text-center">
                        ...
                        <div class="social-icons follow-icons"><a href="#" target="_blank"
                              ...
                              class="icon button circle is-outline instagram tooltip" title="Follow on Instagram"
                              aria-label="Follow on Instagram"><i class="icon-instagram"></i></a><a href="#"
                              data-label="Twitter" target="_blank" rel="noopener noreferrer nofollow"
                              class="icon button circle is-outline twitter tooltip" title="Follow on Twitter"
                              aria-label="Follow on Twitter"><i class="icon-twitter"></i></a><a href="#"
                              data-label="Pinterest" target="_blank" rel="noopener noreferrer nofollow"
                              class="icon button circle is-outline pinterest tooltip" title="Follow on Pinterest"
                              aria-label="Follow on Pinterest"><i class="icon-pinterest"></i></a><a href="#"
                              data-label="YouTube" target="_blank" rel="noopener noreferrer nofollow"
   ...
   <div id="main-menu" class="mobile-sidebar no-scrollbar mfp-hide mobile-sidebar-slide mobile-sidebar-levels-1"
      ...
      <div class="sidebar-menu no-scrollbar ">
         ...
         <ul class="nav nav-sidebar nav-vertical nav-uppercase nav-slide" data-tab="1">
            <li id="menu-item-602"
               class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-602"><a
                  href="#">Chủ đề</a>
               <ul class="sub-menu nav-sidebar-ul children">
                  <li id="menu-item-603"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-603"><a
                        href="chu-de/hoa-dam-cuoi/index.html">Hoa đám cưới</a></li>
                  <li id="menu-item-611"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-611"><a
                        href="chu-de/hoa-sinh-nhat/index.html">Hoa sinh nhật</a></li>
                  <li id="menu-item-605"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-605"><a
                        href="chu-de/hoa-giang-sinh/index.html">Hoa giáng sinh</a></li>
                  <li id="menu-item-604"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-604"><a
                        href="chu-de/hoa-dam-tang/index.html">Hoa đám tang</a></li>
                  <li id="menu-item-610"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-610"><a
                        href="chu-de/hoa-ngay-nha-giao-viet-nam/index.html">Hoa ngày nhà giáo Việt Nam</a></li>
                  <li id="menu-item-609"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-609"><a
                        href="chu-de/hoa-le-valentine/index.html">Hoa lễ Valentine</a></li>
                  <li id="menu-item-608"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-608"><a
                        href="chu-de/hoa-le-8-3/index.html">Hoa lễ 8/3</a></li>
                  <li id="menu-item-606"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-606"><a
                        href="chu-de/hoa-khai-truong/index.html">Hoa khai trương</a></li>
                  <li id="menu-item-607"
                     class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-607"><a
                        href="chu-de/hoa-le-20-10/index.html">Hoa lễ 20/10</a></li>
               </ul>
            </li>
            <li id="menu-item-612"
               class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-612"><a
                  href="#">Thiết kế</a>
               <ul class="sub-menu nav-sidebar-ul children">
                  <li id="menu-item-614"
                     class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-614"><a
                        href="thiet-ke/bo-hoa/index.html">Bó hoa</a></li>
                  <li id="menu-item-615"
                     class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-615"><a
                        href="thiet-ke/gio-hoa/index.html">Giỏ hoa</a></li>
                  <li id="menu-item-618"
                     class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-618"><a
                        href="thiet-ke/lang-hoa/index.html">Lẵng hoa</a></li>
                  <li id="menu-item-613"
                     class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-613"><a
                        href="thiet-ke/binh-hoa/index.html">Bình hoa</a></li>
                  <li id="menu-item-616"
                     class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-616"><a
                        href="thiet-ke/hop-hoa/index.html">Hộp hoa</a></li>
                  <li id="menu-item-617"
                     class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-617"><a
                        href="thiet-ke/ke-hoa/index.html">Kệ hoa</a></li>
               </ul>
            </li>
   ...
   <div id="chat-scroll-section" class="chat-scroll-section is-show"><a class="open-chat-list-btn"> <i
            class="nki-chat-main-chatbox"></i> </a>
      <div class="select-chat-field">
         ...
         <div class="sticker-hotline-mobile2"><a href="tel:1900561242"> <i class="nki-call-chatbox"></i> <span
                  class="slide-tooltip">Tổng đài: 1900.56.12.42</span> </a></div>
         <div class="sticker-fb-msg2"><a href="https://m.me/muathemewp" target="_blank" rel="noopener noreferrer"> <i
                  class="nki-mes-chatbox"></i> <span class="slide-tooltip">Chat với chúng tôi</span> </a></div>
                     ...
                     <form class="woocommerce-form woocommerce-form-login login" method="post"
                        ...
                        <p class="form-row">
                           ...
                           <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
                              value="c726a3ba67" /><input type="hidden" name="_wp_http_referer" value="/" /> <button
                              type="submit"
               ...
               <div class="col-2 large-6 col pb-0">
                  <div class="account-register-inner">
                     ...
                     <form method="post" class="woocommerce-form woocommerce-form-register register"
                        action="?mod=user&act=register">
                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                           <label for="reg_email">Họ tên của bạn&nbsp;<span class="required">*</span></label>
                           <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="hoten"
                              id="reg_email" autocomplete="hoten" value="" />
                        </p>
                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        ...
                        <p>
                           ...
                           <input type="password" class="woocommerce-Input woocommerce-Input--text input-text"
                              name="pass" id="reg_email" autocomplete="email" value="" />
                        </p>
                        ...
                        <p class="woocommerce-form-row form-row">
                           <input type="hidden" id="woocommerce-register-nonce" name="woocommerce-register-nonce"
                              value="f6bfe6428e" /><input type="hidden" name="_wp_http_referer" value="/" /> <button
                              type="submit"
   ...
   <script type='text/javascript'
      src='wp-content/themes/flatsome/inc/extensions/flatsome-live-search/flatsome-live-search.js'
   ...
   <script type='text/javascript'
      src='wp-content/themes/flatsome/inc/extensions/flatsome-lazy-load/flatsome-lazy-load.js' id='flatsome-lazy-js'>
   </script>
   <script type='text/javascript' src='wp-content/themes/flatsome/assets/js/woocommerce.js'
...
<![endif]-->
   ...
   <script type='text/javascript' src='wp-content/plugins/woocommerce-products-filter/js/html_types/radio.js'
      id='woof_radio_html_items-js'></script>
   <script type='text/javascript' src='wp-content/plugins/woocommerce-products-filter/js/html_types/checkbox.js'
      id='woof_checkbox_html_items-js'></script>
   <script type='text/javascript' src='wp-content/plugins/woocommerce-products-filter/js/html_types/select.js'
      id='woof_select_html_items-js'></script>
   <script type='text/javascript' src='wp-content/plugins/woocommerce-products-filter/js/html_types/mselect.js'
      id='woof_mselect_html_items-js'></script>
   <script type='text/javascript' src='wp-content/plugins/woocommerce-products-filter/js/chosen/chosen.jquery.js'
