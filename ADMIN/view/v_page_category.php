                        ...
                        <tbody>
                           ...
                           <form action="?admin=category&act=xoasuadm&id=<?php echo $danhmuc['id'] ?>" method="post">
                              ...
                              <tr>
                                       ...
                                       <div class="d-flex flex-column justify-content-center">
                                          <h6 class="mb-0 text-sm">
                                             <input type="text" style="border: none; width: 300px;"
                                                value="<?php echo $danhmuc['tendanhmuc'] ?>" name="tendanhmuc"
                                                class="sua-input">
                                          </h6>
                                       </div>
                                    </div>
                                 ...
                                 <td class="align-middle">
                                    <input type="submit"
                                       style="background-color: #EC407A; border: none;color:white; width:60px;text-align: center;"
                                       value="Sửa" name="sua" width="100">
                                    <input type="submit"
                                       style="background-color: #EC407A; border: none;color:white; width:60px;text-align: center;"
                                       value="Xóa" name="xoa" width="100">
                                 </td>
                              </tr>
                              <?php endforeach; ?>
                           </form>
