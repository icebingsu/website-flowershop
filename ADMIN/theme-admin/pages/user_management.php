  ...
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/user_management.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Người dùng</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3" style="font-size: 1.3em;">Người dùng</h6>
                <p class="" style="color: cornsilk; font-weight: bold; padding-left: 5px;">Số lượng người dùng: 1</p>
              </div>
            </div>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../model/assets/img/small-logos/logo-asana.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../model/assets/img/small-logos/github.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../model/assets/img/small-logos/logo-atlassian.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../model/assets/img/small-logos/bootstrap.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../model/assets/img/small-logos/logo-slack.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../model/assets/img/small-logos/devto.svg"
