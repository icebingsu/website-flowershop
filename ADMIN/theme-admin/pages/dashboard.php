...
<body class="g-sidenav-show  bg-gray-200">
      ...
      <div class="row mt-4">
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card z-index-2 ">
            ...
            <div class="card-body">
              <h6 class="mb-0 ">Lượt truy cập trang</h6>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Avata</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Chức vụ</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">gì nữa k biết</th>
                    </tr>
                  </thead>
                  <tbody>
                    <!-- user -->
  ...
  <script src="../model/assets/js/plugins/chartjs.min.js"></script>
  <script>
