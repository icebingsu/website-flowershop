  ...
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/product_admin.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><span class="text-secondary text-xs font-weight-bold"><input
                                  type="text" placeholder="Nhập tên"></span></h6>
                          </div>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm" style="text-align: center;">
                        <span class="text-secondary text-xs font-weight-bold"><span
                            class="text-secondary text-xs font-weight-bold"><input type="text"
                              placeholder="Nhập giá"></span></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-secondary text-xs font-weight-bold"><span
                            class="text-secondary text-xs font-weight-bold"><input type="text"
                              placeholder="Nhập số lượng"></span></span>
                      </td style="text-align: center;">
                      <td class="align-middle text-center text-sm">
                      ...
                      <td class="align-middle" style="text-align: center;">
                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                          data-original-title="Edit user" style="text-align: center;">
                          Lưu
                        </a>
                      </td>
                    </tr>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    ...
                    <tr>
                      ...
                      <!-- <th><input type="checkbox" class="" id="checkbox1"><label for="checkbox1"></label></th> -->
                      <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Tên
                      </th>
                      <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Giá
                      </th>
                      ...
                      <th class="text-center text-uppercase  text-secondary text-xxs font-weight-bolder opacity-7">Danh
                        mục</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ngày
                        tạo</th>
                  ...
                  <tbody>
                    <!-- danh mục ở đây -->
                    <tr>
                      <th class="align-middle text-center text-sm" style="width: 100px;"><input type="checkbox" class=""
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-secondary text-xs font-weight-bold">100k</span>
                      </td>
                      <td class="align-middle text-center text-sm">
